...
public class CsvDatabaseImplementation<T> implements CoreDatabase<T> {
    ...
    @SneakyThrows
    public CsvDatabaseImplementation(String entityName, Class<?> entityType) {
    ...
    public void create(T data) {
        try {
            ...
            if (!dataFile.exists()) {
                ...
                MappingIterator<T> dataMappingIterator = mapper.readerFor(data.getClass()).with(csvSchema)
                        .readValues(dataFile);
    ...
    public List<T> getList() {
        ...
        CsvSchema csvSchema = mapper.schemaFor( entityType).withHeader();

        // Read existing CSV file into List of T objects
        MappingIterator<T> dataMappingIterator = mapper.readerFor(entityType).with(csvSchema).readValues(dataFile);
    ...
    public void delete(int id) {
        ...
        csvSchema = mapper.schemaFor(entityType).withHeader();
        ...
        this.mapper.writer(csvSchema).writeValue(dataFile, dataList);
